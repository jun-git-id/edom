...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">EDOM</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= url('/kajur') ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseHasilKuisioner" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= url('/kajur/hasil-evaluasi/dosen') ?>">Dosen</a>
                        <a class="collapse-item" href="<?= url('/kajur/hasil-evaluasi/matkul') ?>">Matkul</a>
                        <a class="collapse-item" href="<?= url('/kajur/hasil-evaluasi/jurusan') ?>">Jurusan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseGrafikTahunan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= url('/kajur/grafik-tahunan/jurusan') ?>">Jurusan</a>
                        <a class="collapse-item" href="<?= url('/kajur/grafik-tahunan/prodi') ?>">Prodi</a>
                        <a class="collapse-item" href="<?= url('/kajur/grafik-tahunan/dosen') ?>">Dosen</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->major_chief->nama }}</span>
                                <img class="img-profile rounded-circle" src="<?= url('/img/user-alt-512.webp') ?>">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Politeknik Negeri Cilacap 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?= url('/template-admin/vendor/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= url('/template-admin/vendor/jquery-easing/jquery.easing.min.js') ?>"></script>
