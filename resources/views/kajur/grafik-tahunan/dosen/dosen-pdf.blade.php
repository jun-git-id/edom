...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        ...
        <a id="grafik-button" href="<?= url('/kajur/hasil-evaluasi/dosen/dosen/' . $dosen_id . '/grafik') ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-chart-bar fa-sm text-white-50"></i> Tampilan Grafik</a>
...
<script>
    ...
    const tampilData = data => {
        ...
        $('#pdf-button').attr('href',`<?= url('/kajur/hasil-evaluasi/dosen/dosen/' . $dosen_id . '/pdf?tahun_id=${data.tahun_id}') ?>`);
