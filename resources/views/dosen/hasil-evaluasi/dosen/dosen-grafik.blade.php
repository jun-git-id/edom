...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="<?= url('/dosen/hasil-evaluasi/pert/') ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-sticky-note fa-sm text-white-50"></i> Per Pertanyaan</a>
        <a href="<?= url('/dosen/hasil-evaluasi/') ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-table fa-sm text-white-50"></i> Tampilan Tabel</a>
    ...
    const tampilData = data => {
        ...
        data.ajaran.forEach(dt => {
            const el = `<tr>
                            ...
                            <td> <a href="<?= url('/dosen/hasil-evaluasi/dosen/ajaran/${dt.id}') ?>"><i class="fas fa-search-plus"></i></a> </td>
                        </tr>`;
            $('#ajaran').append(el);
        ...
        $('#pdf-button').attr('href', `<?= url('/dosen/hasil-evaluasi/pdf?tahun_id=${data.tahun_id}&grafik=yes') ?>`);
