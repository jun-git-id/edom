...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        ...
        <a id="grafik-button" href="<?= url('/dosen/hasil-evaluasi/grafik') ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-chart-bar fa-sm text-white-50"></i> Tampilan Grafik</a>
    ...
    const tampilData = data => {
        ...
        data.ajaran.forEach(dt => {
            const el = `<tr>
                            ...
                            <td> <a href="<?= url('/dosen/hasil-evaluasi/ajaran/${dt.id}') ?>"><i class="fas fa-search-plus"></i></a> </td>
                        </tr>`;
            $('#ajaran').append(el);
        ...
        $('#pdf-button').attr('href',`<?= url('/dosen/hasil-evaluasi/pdf?tahun_id=${data.tahun_id}') ?>`);
