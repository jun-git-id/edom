...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="<?= url('/dosen/hasil-evaluasi/dosen/dosen/' . $dosen_id) ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-table fa-sm text-white-50"></i> Per Kelas</a>
        <a href="<?= url('/dosen/hasil-evaluasi/dosen/dosen-pert/' . $dosen_id) ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-table fa-sm text-white-50"></i> Tampilan Tabel</a>
...
<script>
    ...
    const tampilData = data => {
        ...
        $('#pdf-button').attr('href',`<?= url('/dosen/hasil-evaluasi/dosen/dosen-pert/' . $dosen_id . '/pdf?tahun_id=${data.tahun_id}&grafik=yes') ?>`);
