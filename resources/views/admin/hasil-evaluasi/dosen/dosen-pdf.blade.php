...
<body id="page-top">
    ...
    <div>
        ...
        <table id="keterangan">
            <tr id="keterangan_tr">
                <td id="keterangan_td">Ketua Jurusan {{ $kajur->major->nama_jurusan }} </td>
            </tr>
            <tr id="keterangan_tr">
                <td id="keterangan_td">
                    <img height="50" width="50" src="<?= public_path("/ttd-kajur/$kajur->ttd") ?>" alt="" srcset="">
                </td>
            </tr>
            <tr id="keterangan_tr">
                <td id="keterangan_td">{{ $kajur->nama }} </td>
            </tr>
        </table>
    </div>
