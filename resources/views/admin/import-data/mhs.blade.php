...
<div class="card">
    <div class="card-body">
        Download template excel import Mahasiswa. <br>
        <a class=" btn btn-outline-primary" href="<?= url('/template-import-excel/edom-excel-import-mhs.xlsx') ?>" download="">Download</a>
    </div>
</div>
...
<div class="row" style="padding-top: 30px">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/admin/import-data/mhs') }}" method="post" enctype="multipart/form-data">
                    @csrf
